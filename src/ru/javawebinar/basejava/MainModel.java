...
public class MainModel {
    public static void main(String[] args) {
        ...
        rc.setAddress("myCity");
        rc.setEmail("myMail");
        rc.setContacts();
        System.out.println(rc);
        rs.setPersonal("personalInfo");
        rs.setObjective("objectiveInfo");
        rs.setAchievement("achievementInfo 1");
        rs.setAchievement("achievementInfo 2");
        rs.setQualifications("qualificationsInfo");
        rs.setExperience("experienceInfo");
